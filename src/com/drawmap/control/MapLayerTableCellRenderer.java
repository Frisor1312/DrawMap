...
//                "/org/geotools/swing/icons/eye_closed.png"))
            new ImageIcon("icons/unhide.png"),
            new ImageIcon("icons/hide.png")
        ),
...
//        w = LayerControlItem.SELECTED.getIcon().getIconWidth();
    ...
    private JLabel visibleLabel;		//可显示图层
//    private JLabel selectedLabel;		//选中图层
    private JLabel styleLabel;			//风格化图层
    private JLabel removeLayerLabel;	//删除图层
    private JLabel nameLabel;			//图层名
     ...
     */
    public static boolean hitVisibilityLabel(Point p) {  //当鼠标点击了可显示图层label时将会调用
